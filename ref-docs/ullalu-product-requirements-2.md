...
If preceding activities cause an estimated arrival after 19:00, Ullalu should surface a warning.
...
The internal format may be structured JSON packaged as an Ullalu document.
...
# 34. AI-Assisted Planning (Later, Paid)

AI is an optional premium layer that will be wired into Ullalu only after the core itinerary, routing, storage, and time-geometry experience is stable.

The governing principle is:

> **Ullalu must remain a fully useful itinerary planner with AI turned off. AI assists the traveller; it does not own the itinerary engine.**
...
- identifying fixed-time conflicts
- routing between places
- saving, loading, or exporting trips
- using Ullalu offline for already-saved itinerary data

Deterministic and trusted services remain authoritative for factual itinerary data such as:
...
AI may later assist with higher-level planning tasks such as:

- converting rough notes into proposed itinerary items
- suggesting how to use available free time
- suggesting activities that fit a specific time window
- identifying days that appear overly ambitious
- proposing ways to reduce travel
- suggesting a better ordering of activities
- helping rebalance a day
- explaining warnings and schedule conflicts
- answering questions about the traveller's itinerary

Examples:

```text
You have 3h 20m free in Shibuya
between 15:10 and dinner at 18:30.

[ Ask Ullalu what I can do ]
```
...
AI-generated itinerary changes must always be presented as proposals.
...
Move Ueno Park to Day 5

Day 4
Travel       5h 10m → 3h 45m
Free time       20m → 2h 05m

[ Preview change ]
```

AI must never silently rewrite a user's itinerary.

AI should preferably appear contextually rather than as a generic chatbot attached to every screen.
...
Rough trip notes
→ Build proposed itinerary
```

AI usage should be opt-in and tied to Ullalu's paid offering.

Because itineraries may contain sensitive information such as exact travel dates, hotels, routes, and locations, Ullalu must clearly explain when itinerary information will be sent to an AI provider.

When AI is disabled, itinerary content must not be sent to an AI provider.

Product invariant:

> **AI is opt-in, advisory, paid, and reversible. Deterministic itinerary calculations remain authoritative.**
...
AUTH / DRIVE / CLOUD
    ↓
AI-ASSISTED PLANNING (PAID, LATER)
    ↓
PUBLISH / EXPLORE
```
...
24. **AI is optional, paid, advisory, and must never own deterministic itinerary calculations.**
25. **The planning experience must be excellent before community features are prioritised.**

---

# 38. Current Product Positioning
