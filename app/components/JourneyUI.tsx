...
export function SuggestionIcon({ kind }: { kind: "place" | "transport" | "reservation" | "rest" | "buffer" }) {
  ...
  if (kind === "place") return <svg {...common}><path d="M12 21s6-5.2 6-11a6 6 0 1 0-12 0c0 5.8 6 11 6 11Z"/><circle cx="12" cy="10" r="2"/></svg>;
  if (kind === "transport") return <svg {...common}><rect x="5" y="4" width="14" height="14" rx="3"/><path d="M8 18v2m8-2v2M7.5 8h9M8 14h.01M16 14h.01"/></svg>;
  if (kind === "reservation") return <svg {...common}><rect x="4" y="5.5" width="16" height="14" rx="2"/><path d="M8 3v5m8-5v5M4 10h16M8 14h3"/></svg>;
  if (kind === "rest") return <svg {...common}><path d="M4 16V9m0 5h16v5m-16 0v-3m16 3v-3M7 9h5a3 3 0 0 1 3 3v2H7Z"/></svg>;
  ...
  return (
    <div className={styles.mountainFooter} aria-hidden="true">
      ...
      {variant === "japan" ? (
        <svg
          viewBox="0 0 390 132"
          style={{ position: "absolute", left: -20, right: -20, bottom: -8, width: "calc(100% + 40px)", height: 132 }}
        >
          ...
          <path d="M258 118h74M268 109h55M276 98h39M282 87h28" fill="none" stroke="#b85d59" strokeWidth="1.4" strokeLinecap="round" />
          <path d="M296 55v63M286 78h20M280 89h32M274 101h44M267 111h58" fill="none" stroke="#b85d59" strokeWidth="1.4" strokeLinecap="round" />
          <path d="m296 49 5 7h-10Z" fill="none" stroke="#b85d59" strokeWidth="1.4" strokeLinejoin="round" />
          <path d="M31 117c12-16 21-24 31-31 4 15 14 26 27 31" fill="none" stroke="#6d8b9d" strokeWidth="1.4" strokeLinecap="round" />
        </svg>
      ) : (
